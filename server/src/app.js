...
import bookingInfoSectionRoutes from './routes/bookingInfoSectionRoutes.js';
import consultationSectionRoutes from './routes/consultationSectionRoutes.js';
...
app.use('/api/booking-info-section', bookingInfoSectionRoutes);
app.use('/api/consultation-section', consultationSectionRoutes);
